...
class MenuInvoiceClub:
    @staticmethod
    def title() -> Literal["""Доступ в Нейро Старт"""]: ...
    @staticmethod
...
❗️ Поэтому залетай в наше клубное сообщество и прокачивай свои навыки."""]: ...
    @staticmethod
    def description() -> Literal["""Я собрала простой пошаговый клуб, где ты с нуля начинаешь делать креативы в нейросетях и монетизировать навык.  
