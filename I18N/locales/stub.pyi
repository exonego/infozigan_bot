...
class MenuButton:
    ...
    @staticmethod
    def pay(*, price: PossibleValue) -> Literal["""💳 Оплатить { $price }₽"""]: ...
...
❗️ Поэтому залетай в наше клубное сообщество и прокачивай свои навыки."""]: ...
    @staticmethod
    def description(*, price: PossibleValue) -> Literal["""🤖 Клубное обучение системной работе с нейро генерациями, монтаж вирусных роликов и как заработать на нейронках в 2026 году.
‼️ До конца месяца стоимость { $price }₽
